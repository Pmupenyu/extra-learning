def whatsapp_text(main_text = ("Hello and Welcome to *Home Learning* one of the best *e-learning* platform in *Zimbabwe*. "
...
def other_text(whatsapp_text):
    print(whatsapp_text)

other_text(whatsapp_text)